...
from .keyboard_menus import get_main_menu
...
def aggregate_user_balances(user):
    total_balance_usd = 0
...
def notify_users():
    ...
    for user in users_with_unpaid_minutes:
        ...
        bot.send_message(user_id, f"You have insufficient balance to pay {unpaid_minutes:.4f} additional minutes. "
                                  f"Please top up your wallet.", reply_markup=get_main_menu())
